...
| `KB_STORE_URL`                        | Unset                  | KB Store endpoint. Required when `KNOWLEDGE_STORE_MODE=remote`; remote Recipe mode replays champion Explore args/env at T0 and writes one final session at CLOSE. |
