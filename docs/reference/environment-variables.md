...
| `OPENAI_BASE_URL`      | Conditional | —    | LLM gateway URL. Required for the single-gateway setup; split-gateway deployments can provide provider-specific base URLs instead. Production: `https://your-openai-compatible-gateway.example.com/v1`.                                                                                                                  |
