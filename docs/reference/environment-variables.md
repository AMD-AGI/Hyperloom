...
| `FORGE_CLAUDE_MODEL`  | No       | Inherits `CLAUDE_MODEL` | Forge-fusion Claude backend model id. Set when Forge should use a different Claude model than orchestration.                                                                                   |
| `FORGE_CODEX_MODEL`   | No       | Inherits `CODEX_MODEL`  | Forge-fusion Codex backend model id. Set when Forge should use a different Codex model than the OpenAI-side default.                                                                          |
