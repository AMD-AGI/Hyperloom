...
myst:
    html_meta:
        "description": "Explore Hyperloom's specialized components: IntelliKit for GPU profiling, Magpie for benchmarking, TraceLens for trace analysis, Origami for analytical GEMM selection, GEAK for kernel optimization, and AgentKernelArena for agent evaluation."
        "keywords": "Hyperloom, components, IntelliKit, Magpie, TraceLens, Origami, GEAK, AgentKernelArena, GPU profiling, benchmarking, GEMM selection, kernel optimization, AMD GPU, ROCm, evaluation"
---
...
| [Origami](origami.md) | Optional analytical selection and paired validation for AITER GEMM fallbacks | [ROCm/rocm-libraries](https://github.com/ROCm/rocm-libraries/tree/develop/shared/origami) | [Origami README](https://github.com/ROCm/rocm-libraries/tree/develop/shared/origami) |
