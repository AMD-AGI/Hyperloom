...
|--------------------|-------------------------------------|-------------------------------------------------------------------------------------------------------|---------------------|
| `SAFE_API_KEY`     | AMD LiteLLM gateway                 | [LLM Gateway](https://core42.example-internal-host.invalid/litellm-gateway)                                     | `ak-...`            |
| `OPENAI_BASE_URL`  | AMD LiteLLM gateway                 | `https://core42.example-internal-host.invalid/api/v1/llm-proxy/v1` (default for the hosted SaFE setup)          | URL                 |
...
export OPENAI_BASE_URL=https://core42.example-internal-host.invalid/api/v1/llm-proxy/v1
```
...
When you launch through the [Hyperloom UI](https://core42.example-internal-host.invalid/hyperloom/),
