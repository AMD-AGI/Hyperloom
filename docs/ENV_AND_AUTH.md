...
|--------------------|-------------------------------------|-------------------------------------------------------------------------------------------------------|---------------------|
| `SAFE_API_KEY`     | AMD LiteLLM gateway (typical)         | [LLM Gateway](https://your-openai-compatible-gateway.example.com/litellm-gateway)                                     | `ak-...`            |
| `OPENAI_BASE_URL`  | Same gateway                        | `https://your-openai-compatible-gateway.example.com/v1` (default for hosted SaFE)                  | URL ending in `/v1` |
