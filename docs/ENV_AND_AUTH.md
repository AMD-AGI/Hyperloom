...
| `TRACELENS_ROOT`   | Profile & kernel detection                         | `/workspace/TraceLens` | Path to a checkout of the public [AMD-AGI/TraceLens](https://github.com/AMD-AGI/TraceLens) repo. |
