...
> The search strategy used in EXPLORE — depth-first traversal of a
> heuristic-scored action tree, dynamic specialist construction per
> bottleneck, and KB-driven scoring priors — is described in
