...
| `OPENAI_BASE_URL`      | yes      | —       | LLM gateway URL. Production: `https://your-openai-compatible-gateway.example.com/v1`.                                                                                                                  |
