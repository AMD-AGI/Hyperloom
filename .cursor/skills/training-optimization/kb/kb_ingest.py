#!/usr/bin/env python3
"""Ingest a new entry into the training optimization knowledge base.
...
Usage:
    ...
    python3 kb_ingest.py \
        ...
        --lesson "Fused Triton permute for MoE token dispatch, +1.19% on 8xMI355X" \
        --tags moe,permute,fusion \
        --gain 1.19 --status KEEP
"""
...
def main():
    parser = argparse.ArgumentParser(description="Ingest a training optimization KB entry")
    ...
    parser.add_argument("--gain", type=float, default=None, help="ms/iter reduction percent")
