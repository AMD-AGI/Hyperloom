...
Backend switches that replace vendor C++ kernels with Triton implementations create new OOB optimization surface. Always re-run profiling after backend exploration settles.
...
- After re-profile: rescore all OOB kernel/code candidates with new GPU time percentages
