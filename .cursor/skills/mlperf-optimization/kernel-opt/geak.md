...
|----------|-------|-------------|
| `GEAK_IMAGE` | `harbor.oci-slc.primus-safe.amd.com/sync/tasimage/primus:gpt-oss-20b_training_6.0_2026-04-07-19-47-24_dev` | Primus training image for GEAK pod |
