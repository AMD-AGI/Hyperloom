"""Knowledge base entry schema, validation, and conflict detection for MLPerf optimization."""
...
def resolve_conflict(new_entry: dict, conflict: dict) -> dict:
    ...
    if new_is_controlled and not old_is_controlled:
        resolution["action"] = "SUPERSEDE"
        resolution["reason"] = "New entry has stricter methodology"
