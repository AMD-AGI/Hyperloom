...
# Installs Hyperloom fully-local mode dependencies into a user-provided image.
# Design: deploy/fully-local/DESIGN.zh.md section 7
...
# ---------- config (env-overridable, see DESIGN.zh.md 7.6) ----------
...
# GEAK config template for Hyperloom fully-local mode (BYOI).
