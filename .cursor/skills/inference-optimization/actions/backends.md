...
**Remote mode:** `ServerArgs` inspection and all backend test commands must run via `exec_on_gpu`. See [`../modes/REMOTE.md`](../modes/REMOTE.md) "Backends" section for wrapper syntax.
