...
| `kernel-opt/codex.md` | Deep reference — Codex backend via OOB Agent MCP (fast Triton rewrites) |
| `kernel-opt/claude.md` | Deep reference — Claude Code backend via OOB Agent MCP (multi-step, experimental) |
