...
class ModelGpuFitDetector:
    ...
    def __init__(self, config: ModelGpuFitConfig | None = None) -> None:
        self._config = config or ModelGpuFitConfig()
        self._fired_fingerprint: tuple[Any, ...] | None = None
...
class AmdahlCeilingDetector:
    ...
    def __init__(self, config: AmdahlCeilingConfig | None = None) -> None:
        self._config = config or AmdahlCeilingConfig()
        self._fired_mtime: float | None = None
