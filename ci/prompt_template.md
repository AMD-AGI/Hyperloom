...
```bash
curl -sk -X POST "https://core42.example-internal-host.invalid/api/v1/workloads" \
...
- To poll status: `curl -sk "https://core42.example-internal-host.invalid/api/v1/workloads/$WID" -H "Authorization: Bearer {safe_api_key}"`
- To get logs: `curl -sk "https://core42.example-internal-host.invalid/api/v1/workloads/$WID/pods/$PID/logs" -H "Authorization: Bearer {safe_api_key}"`
