...
1. Go to **[oci-slc.example-internal-host.invalid/hyperloom](https://oci-slc.example-internal-host.invalid/hyperloom/)** and bind your LLM Gateway key to Hyperloom
