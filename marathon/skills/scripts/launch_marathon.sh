...
#   Pane 0: Watchdog Supervisor (skills/watchdog/SKILL.md)
#   Pane 1: Orchestrator (skills/SKILL.md)
#   Pane 2: Kernel Manager (skills/kernel-manager/SKILL.md)
#
# Usage:
...
SKILL_ROOT="${3:-$(cd "$SCRIPT_DIR/.." && pwd)}"

MARATHON_SKILL="$SKILL_ROOT/SKILL.md"
MANAGER_SKILL="$SKILL_ROOT/kernel-manager/SKILL.md"
WATCHDOG_SKILL="$SKILL_ROOT/watchdog/SKILL.md"
