...
from runtime.cortex_kb_client import CortexKBClient, _normalise_value
...
def test_cortex_post_409_and_urlerror(monkeypatch) -> None:
    ...
    monkeypatch.setattr("runtime.cortex_kb_client.urllib.request.urlopen", conflict)
    ...
    monkeypatch.setattr("runtime.cortex_kb_client.urllib.request.urlopen", neterr)
