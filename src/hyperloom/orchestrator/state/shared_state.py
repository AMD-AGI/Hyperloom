...
class SharedState(_RenderMixin, _ExploreStateMixin):
    ...
    def _collective_integration_snapshot(
        ...
        return {
            ...
            "integration_recovery_action": str(result.get("integration_recovery_action") or ""),
    ...
    def record_collective_integration(
        ...
        *,
        ...
        integration_status = str(integration.get("integration_status") or "").strip()
        if integration_status not in {"complete", "recovery_required"}:
            raise ValueError("Collective integration_status must be complete or recovery_required")
        recovery_action = str(integration.get("integration_recovery_action") or "").strip()
        ...
        if integration_status == "recovery_required" and recovery_action not in {"finalize", "revert"}:
