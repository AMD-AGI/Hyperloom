...
class ConversationCollaborator:
    ...
    def _specialist_findings_seed_block(self) -> str:
        ...
        Any domain's round with non-empty new_findings or residual_questions,
        ordered by confidence descending. Executable proposals are not rendered
        here: they go through ``=== Untested proposals (current cycle) ===``,
        which also drops the ones already benched.
        """
        from ..knowledge import research_hints as _research_hints
