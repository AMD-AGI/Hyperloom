    ...
    async def _run_rewrite_lane(self) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                env_spec = {}
            # Built here rather than reused from the GEMM dispatch: a KEEP in an
            # earlier lane has already rewritten current_best, and the handoff
            # has to describe the stack the Controller will measure against.
            ...
            handoff_dir = write_forge_handoff(context, handoff_dir, baselines=baselines)
