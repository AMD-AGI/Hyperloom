    ...
    for i, variant in enumerate(grid):
        ...
        results.append(
            VariantResult(
                ...
                output_tput_per_gpu=measurement.get("output_tput_per_gpu"),
                intvty_p50=measurement.get("e2e_intvty_p50"),
                tpot_p90_ms=measurement.get("tpot_p90_ms"),
                intvty_p90=measurement.get("e2e_intvty_p90") or measurement.get("e2e_norm_intvty_p90"),
                ttft_p50_ms=measurement.get("ttft_p50_ms"),
                ttft_p90_ms=measurement.get("ttft_p90_ms"),
                tpot_p50_ms=measurement.get("tpot_p50_ms"),
                request_error_rate=measurement.get("request_error_rate"),
                submission_valid=measurement.get("submission_valid"),
                submission_invalid_reasons=list(measurement.get("submission_invalid_reasons") or []),
                workspace=str(workspace),
                report_path=str(report_path) if report_path.exists() else None,
                raw_result_path=measurement.get("raw_result_path"),
                reported_success=measurement.get("reported_success"),
