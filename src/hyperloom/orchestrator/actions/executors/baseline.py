    ...
    for idx, patch in enumerate(patches):
        ...
        try:
            ...
            if checked.returncode == 0:
                ...
                detail = checked.stderr.decode(errors="replace")[:500] if checked.stderr else "git apply --check failed"
                raise RuntimeError(detail)
        ...
        *,
        ...
        if not double_run:
            ...
            try:
                ...
                if applied_patches and _pre_patch_sha and not isinstance(patch_application, dict):
                    _revert_patches(
                        patch_target,
                        _pre_patch_sha,
