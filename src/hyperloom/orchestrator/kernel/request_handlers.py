...
# Tests and legacy callers import these from request_handlers.
_resolve_fp8_quant_type = resolve_fp8_quant_type
...
def _resolve_forge_precision_and_quant(state, payload: dict) -> tuple[str, str]:
    from .kernel_context import resolve_workload_precision_and_quant

    return resolve_workload_precision_and_quant(state, payload)
