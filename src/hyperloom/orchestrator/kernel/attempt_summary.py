...
def _render_collective_attempt_row(
    ...
    # A collective's microbenchmark routinely overstates its end-to-end worth (a 27.8%-of-GPU-time kernel at 1.11x
    # micro landed at +0.39% E2E), so a row that has no E2E number must not read as a measured gain.
