...
class Coordinator(metaclass=_CoordinatorMeta):
    ...
    _COLLAB_MODULES = {
        ...
        "resume_helper": ("_resume", "ResumeCollaborator"),
        "writeback": ("_writeback", "WritebackCollaborator"),
        "gating": ("_gating", "GatingCollaborator"),
        "dispatcher": ("_dispatcher", "DispatcherCollaborator"),
        "proposals": ("_proposals", "ProposalsCollaborator"),
        "advisory": ("_advisory", "AdvisoryCollaborator"),
        "inline_actions": ("_inline_actions", "InlineActionsCollaborator"),
        "conversation": ("_conversation", "ConversationCollaborator"),
    }
    ...
    def __init__(
        ...
        *,
        ...
        try:
            from inference_optimizer.storage.schema import set_lane_capacity as _set_lane_capacity
    ...
    def phase_prelude(self):
        from ._phase_prelude import PreludePhase
