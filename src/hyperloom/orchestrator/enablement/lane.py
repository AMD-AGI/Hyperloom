...
class EnablementLane(CoordinatorCollaborator):
    ...
    def _maybe_rearm_enablement(self, res: dict[str, Any] | None) -> None:
        ...
        # Absolute and not the session-relative path just recorded: the revalidation baseline opens this file
        # directly, and the breakdown collector relativizes it on the way into SBD.
