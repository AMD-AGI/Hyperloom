...
`hyperloom-qwen3-14b-fp8-12h-atom`, which pins `KERNEL_OPT_BACKEND_ORDER=forge`
itself; tell the user which backend was selected and why, rather than asking.
