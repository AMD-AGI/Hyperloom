...
try:
    from _server_flag_denylist import (  # noqa: E402  -- shipped beside this script on pods
        _denied_extra_args,
    )
except ImportError:
    pass
...
try:
    from _sglang_shape_gate import (  # noqa: E402  -- shipped beside this script on pods
        _maybe_activate_kernel_shape_tool,
    )
except ImportError:
    pass
