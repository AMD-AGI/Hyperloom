...
#: The enablement substreams: the event, and one row per repair round.
...
EVENT_SECTIONS: tuple[str, ...] = (
    KERNEL_EVENT_SECTIONS + ROOFLINE_EVENT_SECTIONS + BASELINE_EVENT_SECTIONS + ENABLEMENT_EVENT_SECTIONS
)
