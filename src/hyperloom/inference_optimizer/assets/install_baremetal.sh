...
SGLANG_REF="${SGLANG_REF:-d158602ff1d2cb953196c95158c488d503d2470c}"
# When the pin is a bare commit, setuptools_scm may not derive a release version;
# declare the point release for editable/source installs. Moves with SGLANG_REF.
