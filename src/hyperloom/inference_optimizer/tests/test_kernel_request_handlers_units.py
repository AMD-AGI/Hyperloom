...
def test_removed_parallel_backend_compatibility_stays_removed():
    assert not hasattr(krh, "_should_parallelize_backends")
    assert "parallel_backends" not in krh._run_kernel_backend_sequence.__annotations__
