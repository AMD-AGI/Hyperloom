...
class TestTheChartFollowsTheGradedAxis:
    ...
    def test_the_chart_axes_match_the_graded_mode(self, monkeypatch, mode: str, env: dict[str, str]):
        """The chart selects AgentX vs synthetic axes based on the graded metric."""
        from hyperloom.orchestrator.kernel import conc_sweep_plot as plot
