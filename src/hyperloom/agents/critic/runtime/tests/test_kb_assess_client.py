...
from hyperloom.agents.critic.runtime.kb_assess_client import ASSESS_PATH, KBAssessClient
...
def test_assess_posts_to_v2_reasoning_assess(monkeypatch):
    ...
    monkeypatch.setattr("hyperloom.agents.critic.runtime.kb_assess_client.urllib.request.urlopen", _fake_urlopen)
...
def test_assess_swallows_errors_and_returns_none(monkeypatch):
    ...
    monkeypatch.setattr("hyperloom.agents.critic.runtime.kb_assess_client.urllib.request.urlopen", _boom)
