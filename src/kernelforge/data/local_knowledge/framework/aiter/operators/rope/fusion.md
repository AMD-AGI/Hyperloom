...
updated: 2026-07-14
sources:
  - ROCm/aiter@b467ce342:aiter/ops/fused_qk_norm_rope_cache_quant.py
  - ROCm/aiter@b467ce342:aiter/ops/triton/fusions/fused_kv_cache.py
...
- `fused_qk_norm_rope_cache_quant_shuffle` (aiter, standard RoPE).
...
| form | impl | folds in |
|---|---|---|
| QK-norm+RoPE+KV+quant | `fused_qk_norm_rope_cache_quant_shuffle` | norm, rope, kv-write, fp8 |
...
## Sources
- QK-norm+RoPE+KV+quant fusion: `aiter/ops/fused_qk_norm_rope_cache_quant.py`.
- RoPE+KV / QKV-split+RoPE (Triton): `aiter/ops/triton/fusions/fused_kv_cache.py`, `aiter/ops/triton/rope/fused_qkv_split_qk_rope.py`.
