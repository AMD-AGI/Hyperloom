...
sources:
  ...
  - ROCm/aiter@b467ce342:aiter/ops/flydsl/grouped_moe_gfx1250.py
...
| ck | 🟡 competitive | ck |
| hip | 🟡 competitive | hip |
| aiter | 🟢 sota | [aiter.md](aiter.md) |
| tilelang | 🧪 experimental | tilelang |
| flydsl | 🟢 sota (2-stage gate+up / down GEMM, fp8/bf16; a8w4/a4w4 grouped GEMM on gfx1250, JIT) | flydsl |
