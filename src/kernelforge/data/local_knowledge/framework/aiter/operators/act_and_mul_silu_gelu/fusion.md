...
sources:
  ...
  - ROCm/aiter@b467ce342:aiter/ops/flydsl/kernels/moe_gemm_2stage.py
---
...
## Sources
- act+quant Triton: `aiter/ops/triton/activation.py`.
- flydsl silu_and_mul_fq + MoE 2stage: `aiter/ops/flydsl/kernels/silu_and_mul_fq.py`, `aiter/ops/flydsl/kernels/moe_gemm_2stage.py`.
