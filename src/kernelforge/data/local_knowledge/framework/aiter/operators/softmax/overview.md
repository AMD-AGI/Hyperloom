...
sources:
  ...
  - ROCm/aiter@b467ce342:aiter/ops/triton/_triton_kernels/softmax.py
...
| backend | status | card |
|---|---|---|
| triton | 🟢 sota (aiter online-softmax impl) | triton |
| aiter | 🟢 sota (Triton + fused-into-attn/topk) | [aiter.md](aiter.md) |
...
## Sources
- aiter Triton online softmax (`_softmax_kernel_online`, running max/sum + correction): `aiter/ops/triton/softmax.py`, `aiter/ops/triton/_triton_kernels/softmax.py`.
