...
| backend | status | card |
|---|---|---|
| aiter | 🟢 sota (KV broadcast in FA/paged-attn) | [aiter.md](aiter.md) |
...
## Sources
- aiter paged-attn `gqa_ratio` 1..32 (in-register broadcast): on-box `ROCm/aiter@b467ce342:aiter/paged_attn.py`.
