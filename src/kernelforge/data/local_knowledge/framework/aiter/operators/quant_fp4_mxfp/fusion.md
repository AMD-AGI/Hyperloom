...
## Sources
- Fused MXFP4 norm/act/MoE quant: `ROCm/aiter@b467ce342:aiter/ops/triton/quant/fused_mxfp4_quant.py`.
- MoE sort+quant HIP kernels: `ROCm/aiter@b467ce342:csrc/kernels/quant_kernels.cu` (`mxfp4_*moe_sort*`), `aiter/ops/quant.py`.
