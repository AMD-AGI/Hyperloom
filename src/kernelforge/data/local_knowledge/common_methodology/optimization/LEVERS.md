...
| `lever_cheap_sweeps.md` | stage 5 | `FORGE_SWEEP_<NAME>` + `sweep_const:` echo, one bench command per data point, joint sweeps, instrument a copy and submit the literal |
