...
| backend | status | card |
|---|---|---|
| aiter | 🟢 sota (live path, bias/scale epilogue) | aiter |
| hipblaslt | 🟢 sota (executed fused kernels) | hipblaslt |
| ck | 🟢 sota (CShuffle CDEElementwise — richest fusion) | [ck.md](ck.md) |
| triton | 🟡 competitive (easy custom epilogue) | triton |
| hip | 🟤 legacy (raw fused kernel) | hip |
| flydsl | 🟡 competitive (MFMA row + LDS CShuffle epilogue) | flydsl |
