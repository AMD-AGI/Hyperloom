...
"""System prompt for the IntelliKit ASM kernel-backend agent."""
...
def build_system_prompt(
    ...
    return f"""\
You are the IntelliKit kernel backend — a specialist in hand-written AMD AMDGCN assembly kernel
...
`patch_co.py` is shipped with the IntelliKit kernel backend at `{PATCH_CO}`.
