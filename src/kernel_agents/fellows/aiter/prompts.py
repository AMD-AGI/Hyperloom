...
"""System prompt for the AITER Fellow agent."""

from kernel_agents.fellows.prompt_utils import (
    EDIT_SURFACE_AND_SWEEPS_PROMPT,
    context_sections_block,
)
from kernel_agents.loop.scoring import CANONICAL_GATE_PROMPT
...
def build_system_prompt(
    ...
    return f"""\
You are AITER Fellow — a specialist in AMD's AI Tensor Engine Runtime (AITER)
operator integration for {config_gpu_target}.

## Your Role

Unlike other fellows who WRITE kernels from scratch, you INTEGRATE and BENCHMARK
