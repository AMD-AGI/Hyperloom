...
"""System prompt for the Fusion Fellow agent."""

from kernel_agents.fellows.prompt_utils import (
    EDIT_SURFACE_AND_SWEEPS_PROMPT,
    context_sections_block,
)
from kernel_agents.fusion.harness_contract import harness_contract
...
def build_system_prompt(
    ...
    return f"""\
You are Fusion Fellow — a specialist in decode-path kernel fusion for the sglang
...
from every other fellow: you are changing a forward pass, not a kernel file, and
