...
FELLOW_PROMPT_MODULES = {
    "ck": "kernel_agents.fellows.ck.prompts",
    "flydsl": "kernel_agents.fellows.flydsl.prompts",
    "triton": "kernel_agents.fellows.triton.prompts",
    "gluon": "kernel_agents.fellows.gluon.prompts",
    "aiter": "kernel_agents.fellows.aiter.prompts",
    "hip": "kernel_agents.fellows.hip.prompts",
    "hipblaslt": "kernel_agents.fellows.hipblaslt.prompts",
    "intellikit": "kernel_agents.fellows.intellikit.prompts",
    "fusion": "kernel_agents.fellows.fusion.prompts",
}
