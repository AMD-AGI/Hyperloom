...
"""Prompt fragments shared between fellows."""
...
# the card. Every fellow carries this block -- the two campaigns that lost these
# moves ran on a fellow whose own prompt never mentioned them.
