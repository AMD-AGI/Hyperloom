...
SERVER_NAME = "kernel-agents-specialist-probe"
...
# ``kernel_agents.loop.fanout.campaign_device_lock_path``. Absent, the probe
...
PRIMITIVE_MODULE = "kernel_agents.mcp_server.tools.bench"
