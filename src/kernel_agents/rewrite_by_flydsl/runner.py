...
from kernel_agents.knowledge.experience_integration import git_checkout_branch
from kernel_agents.knowledge.experience_reader import sanitize_read_error
from kernel_agents.rewrite_by_flydsl import (
    driver_contract,
...
from kernel_agents.rewrite_by_flydsl.agent_kb import kb_store_secrets
from kernel_agents.rewrite_by_flydsl.applyback import generate_applyback_patch
from kernel_agents.rewrite_by_flydsl.attempt import (
    create_attempt_workspace,
    export_import_path,
)
from kernel_agents.rewrite_by_flydsl.kb import (
    RewriteKbReadResult,
    try_flydsl_kb_warmstart,
    write_flydsl_kb_solution,
)
from kernel_agents.rewrite_by_flydsl.optimize import run_optimize
from kernel_agents.rewrite_by_flydsl.port_loop import PortResult, run_port_loop
from kernel_agents.rewrite_by_flydsl.budget import DEFAULT_REWRITE_BUDGET
from kernel_agents.loop.scoring import DEFAULT_SNR_THRESHOLD_DB
