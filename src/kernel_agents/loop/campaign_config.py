...
from kernel_agents.fellows.constants import FELLOW_BACKENDS
from kernel_agents.knowledge.experience_sink import (
...
from kernel_agents.loop.new_path_allowlist import normalize_commit_new_paths
from kernel_agents.mcp_server.tools.pmc import derive_kernel_names
