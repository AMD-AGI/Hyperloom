...
from kernel_agents.fellows.constants import resolve_language_dirs
from kernel_agents.orchestrator.contracts import EvidenceRef
from kernel_agents.orchestrator.supervisor import latest_supervisor_ruling_path
...
class AnalysisEvidenceMixin:
    ...
    def _published_analysis_bundle_root(self, commit: str) -> Path | None:
        ...
        from kernel_agents.orchestrator.analysis import AnalysisAgentService
