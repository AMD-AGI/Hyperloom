...
sources:
  ...
  - ROCm/aiter@b467ce342:csrc/kernels/gated_rmsnorm_quant_kernels.cu
...
## Sources
- Fused norm/act + FP8 quant ops: `ROCm/aiter@b467ce342:aiter/ops/triton/quant/fused_fp8_quant.py`,
  `csrc/kernels/rmsnorm_quant_kernels.cu`, `csrc/kernels/gated_rmsnorm_quant_kernels.cu`.
- Fused QK-norm+RoPE+KV-write+quant: `ROCm/aiter@b467ce342:aiter/ops/fused_qk_norm_rope_cache_quant.py`.
