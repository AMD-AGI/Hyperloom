...
`fused_qk_norm_rope_cache_quant_shuffle` — see rmsnorm fusion.md §3 and rope.
...
## Sources
- aiter add+norm+quant variants: `aiter/ops/rmsnorm.py` (`rmsnorm2d_fwd_with_add_dynamicquant`, `add_rmsnorm_quant`, `_with_add_smoothquant`).
