...
Inherits rmsnorm/numerics.md (fp32 Σx², fp32 γ promote, ε inside mean, fnuz fp8,
...
## Sources
- add-in-IO-dtype + fp32 reduction + store residual_out: `aiter/ops/triton/normalization/rmsnorm.py`.
