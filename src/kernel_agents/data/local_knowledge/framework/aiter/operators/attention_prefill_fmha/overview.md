...
gens: [gfx90a, gfx942, gfx950, gfx1250]
...
attention_decode_paged (sq=1, paged KV, latency-bound).
...
**gfx1250 (MI400)**: aiter adds a dedicated gfx1250 asm FMHA forward — `fmha_fwd_with_sink_asm` (bf16)
and `fmha_fwd_mxfp8_asm` (MXFP8), plus a PR3039 varlen prefill path (`aiter/ops/mha.py`) — alongside the
CK/Triton backends.
