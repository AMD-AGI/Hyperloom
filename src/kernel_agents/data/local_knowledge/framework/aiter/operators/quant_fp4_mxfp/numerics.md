...
3. `s_e8m0 = f32_to_mx_e8m0_scale(block_amax / FP4_MAX)` — rounds the ratio to the nearest power-of-2 exponent.
...
- aiter scale computation (`fp4_utils.f32_to_mx_e8m0_scale` + `MxScaleRoundMode`, power-of-2 max, `e8m0_shuffle`→`shuffle.shuffle_scale`, group 32): `ROCm/aiter@b467ce342:aiter/ops/quant.py`, `aiter/utility/fp4_utils.py`, `aiter/ops/triton/quant/quant.py`.
