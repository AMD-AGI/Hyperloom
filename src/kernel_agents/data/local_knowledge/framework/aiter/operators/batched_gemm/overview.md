...
| backend | status | card |
|---|---|---|
| aiter | 🟢 sota (live dispatch) | [aiter.md](aiter.md) |
| hipblaslt | 🟢 sota (strided-batched kernels) | hipblaslt |
| ck | 🟡 competitive (batched/grouped templates) | ck |
| triton | 🟡 competitive (batched matmul kernels) | triton |
| hip | 🟤 legacy (raw strided-batched / loop) | hip |
| asm | 🟢 (peak per-shape, authored) | asm |
...
- Live dispatch through aiter: `ROCm/aiter@b467ce342:aiter/tuned_gemm.py`.
