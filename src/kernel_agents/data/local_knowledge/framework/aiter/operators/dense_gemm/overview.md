...
| backend | status | card |
|---|---|---|
| aiter | 🟢 sota (live path) | [aiter.md](aiter.md) |
| hipblaslt | 🟢 sota (executed kernels) | hipblaslt |
| flydsl | 🟢 sota (authorable, mixed-precision/MoE) | flydsl |
| triton | 🟡 competitive (loses to tuned hipBLASLt on plain GEMM) | triton |
...
- Live GEMM dispatch through aiter: `ROCm/aiter@b467ce342:aiter/tuned_gemm.py`.
