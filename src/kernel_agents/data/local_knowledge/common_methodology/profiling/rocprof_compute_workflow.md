...
**memory chart**, and an empirical **roofline** ([`roofline_on_mi.md`](roofline_on_mi.md)). It is
...
[`reading_a_kernel_bottleneck.md`](reading_a_kernel_bottleneck.md) and
[`roofline_on_mi.md`](roofline_on_mi.md). The script bakes in no kernel name or bottleneck rule — it
...
- Full decision flow: [`reading_a_kernel_bottleneck.md`](reading_a_kernel_bottleneck.md); roofline
  detail + per-dtype roofs: [`roofline_on_mi.md`](roofline_on_mi.md).
