...
| backend | status | card |
|---|---|---|
| aiter | 🟢 sota (CK/asm `rmsnorm2d_fwd_with_add` / `add_rmsnorm`) | aiter |
| triton | 🟢 sota (`_fused_add_rmsnorm_kernel`) | triton |
| hip | 🟢 sota (vLLM `fused_add_rms_norm_kernel`) | [hip.md](hip.md) |
