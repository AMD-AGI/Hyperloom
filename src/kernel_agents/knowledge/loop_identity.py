...
from kernel_agents.knowledge.implementation_identity import normalize_operator_name
from kernel_agents.knowledge.kernel_identity import KernelRecipeIdentity
...
def resolve_loop_identity(
    *,
    ...
    from kernel_agents.rewrite_by_flydsl.identity import (
        UNKNOWN_SEGMENT,
        framework_version,
        segment,
    )
