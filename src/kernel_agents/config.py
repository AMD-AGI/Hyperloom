...
"""Central configuration for kernel-agents."""
...
from kernel_agents.knowledge.experience_store import KnowledgeConfig
from kernel_agents.resources import default_project_root, resource_path
