...
from kernel_agents.loop.fanout import LaneResult
from kernel_agents.loop.run_state import LoopStateStore, RunState, make_event
from kernel_agents.loop.runner import IterationConfig, IterationLoop
from kernel_agents.orchestrator.contracts import PlanCriticOutcome
...
def test_a_queue_that_cannot_be_written_costs_durability_only(
    ...
    monkeypatch.setattr(
        "kernel_agents.loop.recovery.atomic_write_json", _no_room
    )
