"""Tests for the IntelliKit ASM fellow."""

import os

from kernel_agents.fellows.constants import FELLOW_BACKENDS
from kernel_agents.fellows.intellikit.prompts import (
    build_system_prompt,
    _roofline,
    _roofline_peak,
    PATCH_CO,
...
def test_prompt_contains_gpu_target_not_hardcoded():
    ...
    identity_line = next(l for l in prompt.splitlines() if "IntelliKit Fellow" in l)
