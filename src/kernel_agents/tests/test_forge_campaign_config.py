...
from kernel_agents.knowledge.kernel_identity import kernel_recipe_canonical_id
from kernel_agents.knowledge.loop_identity import resolve_loop_identity
from kernel_agents.loop.campaign_config import (
    CampaignConfig,
    CampaignConfigStore,
