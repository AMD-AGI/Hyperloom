...
from kernel_agents.agent_backends import AgentCapabilities, AgentRunResult
from kernel_agents.config import Config
from kernel_agents.mcp_server import probe_stdio_server as probe_server
...
from kernel_agents.orchestrator import specialists
from kernel_agents.orchestrator.orchestration import _specialist_probe_config
...
async def test_a_probe_locks_the_same_device_sentinel_the_fanout_lanes_do(
    ...
    from kernel_agents.loop.fanout import campaign_device_lock_path
