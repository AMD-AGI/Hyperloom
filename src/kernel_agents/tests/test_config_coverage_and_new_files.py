...
from kernel_agents.loop.runner import (
    IterationConfig,
    IterationLoop,
    IterationResult,
)
from kernel_agents.orchestrator.contracts import CaseEvidence, OrchestrationContext
from kernel_agents.loop import runner as runner_module
from kernel_agents.loop.campaign_config import CampaignConfigStore
from kernel_agents.loop.campaign_setup import resolve_campaign
...
def test_floor_ratio_is_configurable_and_not_read_off_the_keep_gate():
    from kernel_agents.loop.scoring import KEEP_MIN_MARGIN_FRACTION
