...
from kernel_agents.knowledge import pr_monitor_search as search_module
from kernel_agents.knowledge.pr_monitor_client import PRMonitorClient
from kernel_agents.knowledge.pr_monitor_search import (
    HIT_FILE_PATH,
    HIT_RECENT,
    HIT_SEARCH,
    PRReference,
...
from kernel_agents.knowledge.pr_query_context import (
...
class _Service:
    ...
    def install(self, monkeypatch) -> None:
        ...
        monkeypatch.setattr(
            "kernel_agents.knowledge.pr_monitor_client.urllib.request.urlopen",
            self._urlopen,
        )
