...
from kernel_agents.fusion.author import build_author_prompt, build_multi_author_prompt
from kernel_agents.fusion.command import _combined_recipe, _safe_artifact_id
from kernel_agents.fusion.emit import export_artifacts, restore_exported_changes
