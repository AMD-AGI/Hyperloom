...
from kernel_agents.fusion import command as cli
from kernel_agents.fusion.command import (
    _discard_failed_attempt,
    _live_file_restored,
    _needs_discard,
    _snapshot_fusion_source,
)
from kernel_agents.fusion.command import main as cli_main
from kernel_agents.fusion.loop import LoopResult
...
def test_no_inventory_means_nothing_is_claimed_as_author_created(tmp_path):
    ...
    from kernel_agents.fusion.command import _author_created_modules
