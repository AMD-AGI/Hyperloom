...
from kernel_agents.fusion.discover import parse_discovered_recipes
from kernel_agents.fusion.locate import build_recipes, vllm_compile_pass_state, vllm_pass_config_flag
from kernel_agents.fusion.vllm_passes import (
    _PROBE_SRC,
