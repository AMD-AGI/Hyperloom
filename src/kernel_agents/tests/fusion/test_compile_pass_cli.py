...
from kernel_agents.fusion.command import main
from kernel_agents.fusion.vllm_passes import PassState
...
class Harness:
    ...
    def install(self, monkeypatch):
        import kernel_agents.fusion.command as cli
        import kernel_agents.fusion.locate as locate
