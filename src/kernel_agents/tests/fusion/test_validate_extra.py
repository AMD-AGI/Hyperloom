...
from kernel_agents.fusion.models import Recipe
from kernel_agents.fusion.validate import (
    HarnessKernelRunner,
...
from kernel_agents.fusion import validate
...
def test_validate_parity_all_none_fails():
    from kernel_agents.fusion.validate import BenchOutcome, CompileOutcome, ParitySample
...
def test_apply_serving_gate_env_boot_failure_keeps_micro_keep(tmp_path, monkeypatch):
    ...
    from kernel_agents.fusion import command as cli_module
    from kernel_agents.fusion.models import ValidationResult

    from kernel_agents.fusion.validate import SMOKE_STAGE_STARTUP_CRASH, SmokeVerdict
...
def test_apply_serving_gate_cuda_graph_crash_clears_keep(tmp_path, monkeypatch):
    ...
    from kernel_agents.fusion.validate import SMOKE_STAGE_DECODE_CRASH, SmokeVerdict
