...
import kernel_agents.fusion.author
import kernel_agents.fusion.command
import kernel_agents.fusion.discover
import kernel_agents.fusion.emit
import kernel_agents.fusion.locate
import kernel_agents.fusion.validate

MODULES = (
    kernel_agents.fusion.author,
    kernel_agents.fusion.command,
    kernel_agents.fusion.discover,
    kernel_agents.fusion.emit,
    kernel_agents.fusion.locate,
    kernel_agents.fusion.validate,
)
