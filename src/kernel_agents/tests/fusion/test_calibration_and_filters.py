...
from kernel_agents.fusion.diagnose import diagnose_from_shares, load_op_bytes_from_kineto_trace
from kernel_agents.fusion.discover import parse_discovered_recipes
from kernel_agents.fusion.locate import build_recipes, covered_by_vllm_compile_pass
from kernel_agents.fusion.patterns import PATTERNS, match_patterns
