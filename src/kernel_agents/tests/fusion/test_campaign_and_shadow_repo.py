...
from kernel_agents.fusion import campaign as campaign_module
from kernel_agents.fusion.campaign import (
    build_campaign_program_md,
    build_forge_loop_command,
    fused_module_path,
    run_recipe_campaign,
)
from kernel_agents.fusion.driver_shim import render_driver
from kernel_agents.fusion.models import Recipe
from kernel_agents.fusion.shadow_repo import SHADOW_BRANCH, ensure_git_workspace
...
class TestShadowRepo:
    ...
    def test_the_loop_accepts_the_workspace_the_shadow_hands_it(self, tmp_path, monkeypatch):
        ...
        """
        from kernel_agents.loop.campaign_config import create_campaign_config
