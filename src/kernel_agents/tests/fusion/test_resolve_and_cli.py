...
from kernel_agents.fusion import author as author_module
...
from kernel_agents.fusion.emit import export_artifacts
from kernel_agents.fusion.llm_failure import AUTH, LlmUnavailableError
...
def test_autoloop_fails_a_recipe_whose_baseline_could_not_be_restored(
    ...
    from kernel_agents.fusion.shadow_repo import ShadowRepo
...
def test_autoloop_records_which_forge_loop_run_answered_each_recipe(tmp_path, monkeypatch):
    ...
    from kernel_agents.fusion.loop import LoopIteration
...
class TestCliDryRun:
    ...
    def test_unreachable_llm_is_not_written_as_no_opportunity(self, tmp_path, monkeypatch):
        ...
        """
        from kernel_agents.fusion import command as cli_module
        from kernel_agents.fusion.llm_failure import API_ERROR, LlmUnavailableError
