...
from kernel_agents.fusion.diagnose import diagnose_from_shares
from kernel_agents.fusion.locate import build_recipes
from kernel_agents.fusion.patterns import match_patterns
from kernel_agents.fusion.report import build_manifest
from kernel_agents.fusion.shapes import resolve_decode_shapes
