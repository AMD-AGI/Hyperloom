...
from kernel_agents.fusion.author import _arch_phrase, build_author_prompt, build_multi_author_prompt
from kernel_agents.fusion.gpu_arch import canon_arch
