...
from kernel_agents.loop.experience import (
    ExperienceLedger,
    _extract_signature,
)
...
def test_both_ledgers_keep_their_own_truncation_and_cap():
    ...
    from kernel_agents.fusion.loop import FusionExperienceLedger
    from kernel_agents.fusion.loop import _extract_signature as fusion_signature
