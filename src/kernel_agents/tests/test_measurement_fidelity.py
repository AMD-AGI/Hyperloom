...
from kernel_agents.mcp_server.tools import bench as bench_module
...
def test_warmstart_baseline_uses_the_same_repeat_as_the_loop(tmp_path):
    ...
    """
    from kernel_agents.knowledge import experience_integration as ei
...
def test_cli_can_actually_call_kb_warmstart():
    ...
    from kernel_agents.knowledge.experience_integration import kb_warmstart
