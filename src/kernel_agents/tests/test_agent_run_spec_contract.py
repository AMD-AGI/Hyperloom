...
third-party backend registered through the ``kernel_agents.agent_providers``
...
def test_the_consumer_reads_the_published_marker():
    ...
    from kernel_agents.fusion import llm_failure
...
def test_an_unmarked_provider_error_is_not_a_verdict():
    ...
    """
    from kernel_agents.fusion.llm_failure import is_agent_safety_error
