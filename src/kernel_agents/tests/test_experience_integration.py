...
from kernel_agents.knowledge import experience_integration as integ
from kernel_agents.knowledge.experience_store import (
    REMOTE_BACKEND_KB_STORE,
    KnowledgeConfig,
)
from kernel_agents.knowledge.implementation_identity import implementation_signature
from kernel_agents.rewrite_by_flydsl import driver_contract, record_store, runner
from kernel_agents.rewrite_by_flydsl.flydsl_rewrite_driver_preparation import (
    DriverPreflight,
)
from kernel_agents.rewrite_by_flydsl.port_loop import PortResult
...
def _patch_read_solutions(monkeypatch, *sols: dict):
    ...
    monkeypatch.setattr(
        "kernel_agents.knowledge.experience_reader.read_top_solutions",
...
def test_write_experience_to_kb_extracts_run_context(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "kernel_agents.knowledge.experience_sink.write_run_experience",
