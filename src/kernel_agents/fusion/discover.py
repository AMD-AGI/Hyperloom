...
def complete_with_retry(
    ...
    *,
    ...
    Retryable means :data:`~kernel_agents.fusion.llm_failure.RETRYABLE_KINDS`: a generic
...
def default_llm_fn(
    *,
    ...
    Raises :class:`~kernel_agents.fusion.llm_failure.LlmUnavailableError` when the model
...
def discover_recipes(
    ...
    *,
    ...
    :class:`~kernel_agents.fusion.llm_failure.LlmUnavailableError` and that propagates:
