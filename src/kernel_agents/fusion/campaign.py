...
from kernel_agents.fusion.driver_shim import write_driver
from kernel_agents.fusion.models import Recipe, ValidationResult
from kernel_agents.fusion.shadow_repo import SHADOW_BRANCH
from kernel_agents.fusion.validate import DEFAULT_TARGET_SPEEDUP
