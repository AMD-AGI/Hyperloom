...
* :func:`validate_recipe` -- the fine-grained, GPU-optional KERNEL validator used
  by the autoloop (see ``loop.py``). Given a :class:`~kernel_agents.fusion.models.Recipe`
  and an injectable :class:`KernelValidationRunner`, it runs three gates and
  returns a :class:`~kernel_agents.fusion.models.ValidationResult`:
...
def validate_recipe(
    ...
    *,
    ...
    Returns:
        A :class:`~kernel_agents.fusion.models.ValidationResult`. On any failure the
