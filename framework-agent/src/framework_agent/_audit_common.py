...
:mod:`framework_agent.audit` and :mod:`framework_agent.cross_framework`. Kept in
a standalone module so neither of those two imports the other (breaks the
import cycle CodeQL ``py/cyclic-import`` flagged).
"""
