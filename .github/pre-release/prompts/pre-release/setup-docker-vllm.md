...
- **Framework:** vLLM. Ensure the vLLM framework layer is available in this container
  (install with the setup backend if needed).
...
When setup completes successfully, stop. Report only `setup complete: docker/vllm`.
