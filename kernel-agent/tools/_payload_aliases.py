...
hand-maintained duplicate). Behaviour is pinned by ``test_payload_aliases_shim.py``.
TODO(tree-reform): import ``hyperloom.common.payload_aliases`` directly and drop
this shim (P2.7).
"""
