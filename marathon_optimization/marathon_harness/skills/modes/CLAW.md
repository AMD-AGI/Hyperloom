...
- **MCP Servers**: SaFE MCP + GEAK MCP (all remote HTTP)
...
|----------|-------|-------------|
| `GEAK_IMAGE_SGLANG_RAY` | `harbor.core42.example-internal-host.invalid/custom/lmsysorg/sglang:202603270958` | SGLang image with Ray 2.44.1 fix |
...
Trace files on shared NFS — accessible from the Claw client for local kernel analysis.
