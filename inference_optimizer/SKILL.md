...
- **Plateau advisory**: EXPLORE / KERNEL / FRAMEWORK plateau signals
...
### FRAMEWORK phase (Coordinator-internal)
...
`framework` action. Per tick it discovers a candidate batch via
