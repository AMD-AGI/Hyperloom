...
Env overrides:
  ...
  PYTHON, TRACELENS_ROOT, TRACELENS_INTERNAL_ROOT,
  TRACELENS_INSTALL_INTERNAL (=0 to skip TraceLens-internal),
  USER_DATA_PATH,
...
chain_kernel_agent() {
  ...
  export TRACELENS_INSTALL_INTERNAL="${TRACELENS_INSTALL_INTERNAL:-1}"
  local args=()
