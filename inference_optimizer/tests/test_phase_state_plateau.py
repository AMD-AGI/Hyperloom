...
def test_exit_normal_kernel_triggers_via_real_plateau():
    state = SimpleNamespace(
        ...
        pending_escalate_hint="",
        stop_reason="",
        kernel_integrate_keep_satisfied=lambda: False,
        kernel_phase_blocked_on_ray_unresolved=lambda **_: False,
    )
...
def test_exit_normal_kernel_blocked_on_ray_unresolved():
    state = SimpleNamespace(
        phase="KERNEL",
        phase_started_unix=0.0,
        max_minutes=0,
        ...
        stop_reason="",
        kernel_integrate_keep_satisfied=lambda: False,
        kernel_phase_blocked_on_ray_unresolved=lambda **_: True,
    )
