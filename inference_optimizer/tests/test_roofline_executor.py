...
async def test_happy_path_promotes_profile_and_caches_trace_analyze(tmp_path):
    ...
    ta["kernel_roofline_path"] = "/tmp/kernel_roofline.json"
    ta["kernel_roofline_report_path"] = "/tmp/reports/kernel_roofline.json"
    ...
    assert result["kernel_roofline_path"] == "/tmp/kernel_roofline.json"
    assert result["kernel_roofline_report_path"] == "/tmp/reports/kernel_roofline.json"
    ...
    assert cached["kernel_roofline_path"] == "/tmp/kernel_roofline.json"
    assert cached["kernel_roofline_report_path"] == "/tmp/reports/kernel_roofline.json"
