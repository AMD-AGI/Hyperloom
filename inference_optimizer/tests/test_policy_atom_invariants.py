...
def test_no_framework_agent_atom_action_unsupported_rule_name_in_source():
...
def test_framework_still_denied_via_phase_incompatible_under_atom(
    ...
    intent = _delegate("framework_agent") if channel == "delegate" else _propose("framework_agent")
