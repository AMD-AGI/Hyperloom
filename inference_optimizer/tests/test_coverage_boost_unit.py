...
def test_gain_math_branches() -> None:
    from inference_optimizer.orchestrator import gain_math
...
def test_name_mapping_paths() -> None:
    from inference_optimizer.baseline_comparison import name_mapping as nm
...
def test_baseline_summary_from_dict_partial() -> None:
    from inference_optimizer.baseline_comparison.types import BaselineSummary
...
def test_tput_objective_progress_zero() -> None:
    from inference_optimizer.orchestrator.objective import TargetTputObjective
...
def test_baseline_objective_progress_zero_ref(tmp_path) -> None:
    from inference_optimizer.orchestrator.objective import TargetBaselineObjective
...
def test_baseline_objective_invalid_dir() -> None:
    from inference_optimizer.orchestrator.objective import ObjectiveError, TargetBaselineObjective
...
def test_canonical_id_roundtrip_and_errors() -> None:
    from inference_optimizer.recipe_kb import canonical_id as cid
...
def test_attempt_from_dict_with_fitness() -> None:
    from inference_optimizer.recipe_kb.schema import Attempt
...
def test_file_lock_no_fcntl(monkeypatch, tmp_path) -> None:
    ...
    from inference_optimizer.orchestrator.action_executors import _file_lock
...
def test_framework_gap_bottleneck(tmp_path) -> None:
    from inference_optimizer.orchestrator.action_executors import _framework_gap_composer as gc
...
def test_validate_envelope_structural_errors() -> None:
    from inference_optimizer.protocol.intent import IntentValidationError, validate_envelope
...
def test_validate_envelope_happy_path() -> None:
    from inference_optimizer.protocol.intent import IntentType, validate_envelope
...
def test_runtime_bridge_success(monkeypatch, tmp_path) -> None:
    from inference_optimizer.orchestrator.backends import _runtime_bridge as rb
