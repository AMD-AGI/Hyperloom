...
"""Unit tests for :mod:`inference_optimizer.cli_executors`.
...
import inference_optimizer.cli_executors as cli_executors
from inference_optimizer.cli_executors import (
